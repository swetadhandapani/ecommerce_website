...
export default function NewProduct() {
  ...
  // Dispatch action to create a new product
  dispatch(createNewProduct(formData))
    .then((response) => {
      if (response && response.success) {
        console.log("Product created successfully:", response.product);
      } else {
        console.error("Failed to create product:", response.message || "Unknown error");
      }
    })
    .catch((error) => {
  ...
  useEffect(() => {
    if (isProductCreated) {
        toast.success("Product created successfully", {
          ...
          type: "success",
          onClose: () => dispatch(clearProductCreated()),
        });
  ...
  }, [isProductCreated,dispatch,navigate, error]);
              ...
              <div className="form-group">
                ...
                {imagesPreview.map((image) => (
                  <img
                    ...
                    key={image}
                    src={image}
                    alt="Product description or specific content"
                    width="55"
                    height="52"
